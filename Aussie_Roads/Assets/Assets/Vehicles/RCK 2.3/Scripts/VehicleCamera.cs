...
public class VehicleCamera : MonoBehaviour
{
    ...
    public void ShowCarUI()
    {
        ...
        CarUIScript.me.CarUI.speedText.text = ((int)carScript.speed).ToString();
        ...
        if (carScript.carSetting.automaticGear)
        {
            ...
            {
                CarUIScript.me.CarUI.GearText.color = Color.green;
                CarUIScript.me.CarUI.GearText.text = gearst.ToString();
            }
            else if (carScript.speed > 1)
            {
                CarUIScript.me.CarUI.GearText.color = Color.red;
                CarUIScript.me.CarUI.GearText.text = "R";
            }
            else
            {
                CarUIScript.me.CarUI.GearText.color = Color.white;
                CarUIScript.me.CarUI.GearText.text = "N";
            }
        ...
        CarUIScript.me.CarUI.tachometerNeedle.rectTransform.rotation = Quaternion.Euler(0, 0, -thisAngle);
        CarUIScript.me.CarUI.barShiftGUI.rectTransform.localScale = new Vector3(carScript.powerShift / 100.0f, 1, 1);
    ...
    {
        if (!target)
            target = FindObjectOfType<VehicleControl>().transform;
    }

    void Start()
    {
        carScript = (VehicleControl)target.GetComponent<VehicleControl>();
        carScript.m_camera = this;
